...
ignore this
Pol2_peak1 <- read.table(file.path(basepath, "CLASS_2023/CLASSES/03_Nextflow/00_Pol2_NF_CORE_RUN/results/bwa/mergedLibrary/macs/broadPeak/POLR2A_R1_peaks.broadPeak"))
...
# first pipe in the dataframe to GGplot- so it can remember your data column names, need to include the %>% part w code to run 
Pol2_peak1 %>% 
  # set the aes(x= , y= ) 
