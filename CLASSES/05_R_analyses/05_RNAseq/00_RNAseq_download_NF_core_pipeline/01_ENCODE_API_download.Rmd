...
source("/scratch/Shares/rinnclass/CLASS_2023/corrinbowman/CLASS_2023/util/encode_functions.R")
```
...
#this url is coded- so you can make it- write a function to write these url 
...
We will do this later in class but would be way to cumbersome to do on the web.
Thus this function should be pretty handy in the future !
...
#put all this in bash terminal below
