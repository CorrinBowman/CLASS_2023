...
-resume \
-profile singularity \
--reads '/scratch/Shares/rinnclass/CLASS_2023/corrinbowman/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/fastq/*{_read1,_read2}.fastq.gz' \
