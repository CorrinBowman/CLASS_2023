...
#first you have to download this(right below the wget)!!!! put it in the terminal in same file and then you can run 
...
md5 <- samples %>%  # here you need double spaces for md5 stuff 
  ungroup() %>%
...
md5_results <- system("md5sum -c md5.txt") #-c means check the list 
...
cd corrinbowman/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/00_NF_CORE_RNAseq_Pipeline_run
...
base_path <- "/scratch/Shares/rinnclass/CLASS_2023/corrinbowman"
...
final_path <- "/scratch/Shares/rinnclass/CLASS_2023/corrinbowman/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/fastq/"
...
# let's test that the path to fastq works: # this should be true if its false prob in wrong file directory spot- re check file path you set above
...
# write out design.csv THESE NEED TO SAVE IN FILE WITH SAMPLES- /scratch/Shares/rinnclass/CLASS_2023/corrinbowman/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/00_NF_CORE_RNAseq_Pipeline_run
...
i am running- this pipeline for RNA seq here: SET AS WORKING DRECTORY HERE 

/scratch/Shares/rinnclass/CLASS_2023/corrinbowman/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/00_NF_CORE_RNAseq_Pipeline_run2
