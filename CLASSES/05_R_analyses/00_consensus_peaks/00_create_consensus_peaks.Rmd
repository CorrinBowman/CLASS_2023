...
consensus_path <- "CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/Consensus Peaks/"
...
for(i in 1:length(consensus_list)) {
rtracklayer::export(consensus_list[[i]], paste0("results/Consensus Peaks/", names(consensus_list)[i],"_consensus_peaks.bed")) }
...
(2) go to class UCSC account BCHM_5631 under like my data think
(3) my data- custom tracks and load consensus file.
(4) load raw data for your protein- load by file then hit submit 
(5) compare consensus peaks with raw data!

username password- BCHM_5631
make sure your in the class file- when you want to compare to older class click them underneith and hit show then refresh
also zoom out a lot 
block in your data is a consensus peak- zoom all the way out will see lines/boxes this is consensus peaks then compare to old class ones
